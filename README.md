...
7. In Supabase Project Settings > API, copy the Project URL and Publishable key into `.env.local`.
8. In Authentication > URL Configuration, set the Site URL to `http://localhost:3000` for local development.
9. Run `npm run dev`.
