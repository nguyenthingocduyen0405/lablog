...
export default function LabQuestChapterOnePage() {
  ...
  useEffect(() => {
    ...
    getCurrentUser().then((currentUser) => {
      ...
      setScreen(progress.length ? (progress.includes(4) ? "c2" : "map") : "intro");
  ...
  return <ChapterComplete saving={screen === "saving"} error={error} onEnter={enterLabLog} onChapterTwo={() => setScreen("c2")} />;
}
